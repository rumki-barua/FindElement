...
//        }
        ...
        driver.findElement(By.xpath( xpathExpression: "//*[@id=\"input\"]")).Sendkeys("...keysToSend: "Data Science");
         driver.findElement(By.xpath( xpathExpression: "//*[@id=\"addShortcutIcon\"]")).click();
    }
}
